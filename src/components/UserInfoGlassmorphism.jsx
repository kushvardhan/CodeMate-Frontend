...
import { FaArrowLeft, FaMapMarkerAlt, FaVenusMars, FaBirthdayCake, FaEnvelope } from "react-icons/fa";
...
const UserInfoGlassmorphism = () => {
  ...
  const codeSymbols = [
    { symbol: "</>", x: "10%", y: "20%", size: "3rem", color: "var(--color-primary)", rotation: -15 },
    { symbol: "{ }", x: "85%", y: "15%", size: "2.5rem", color: "var(--color-accent)", rotation: 10 },
    { symbol: "[]", x: "75%", y: "75%", size: "2rem", color: "var(--color-primary-light)", rotation: -5 },
    { symbol: "=>", x: "15%", y: "85%", size: "2.2rem", color: "var(--color-accent-light)", rotation: 15 },
    { symbol: "&&", x: "50%", y: "90%", size: "1.8rem", color: "var(--color-primary)", rotation: -10 },
  ];
    ...
    <div className={`min-h-screen relative overflow-hidden ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      {codeSymbols.map((symbol, index) => (
        <motion.div
          ...
          animate={{ 
            opacity: 0.2, 
            scale: 1,
            rotate: [symbol.rotation, symbol.rotation + 5, symbol.rotation - 5, symbol.rotation],
          }}
          transition={{ 
            duration: 0.5, 
            delay: index * 0.1,
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <div className={`relative h-40 ${darkMode ? "bg-gradient-to-r from-indigo-900/40 to-purple-900/40" : "bg-gradient-to-r from-indigo-500/40 to-purple-500/40"}`}>
            <motion.div 
          ...
          <div className="pt-20 pb-8 px-8">
            ...
            <motion.div 
              className={`flex justify-center gap-4 mb-6 text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}
            ...
            >
              <h2 className={`text-lg font-semibold mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>About</h2>
            ...
            >
              <h2 className={`text-lg font-semibold mb-2 ${darkMode ? "text-white" : "text-gray-900"}`}>Skills</h2>

...
const Home = () => {
  ...
  return (
    ...
    >
      {/* WhatsApp-style background with coding icons */}
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
        {/* Base pattern */}
        <div className="absolute inset-0 bg-pattern opacity-30 dark:opacity-10"></div>

        {/* WhatsApp-style repeating code icons pattern */}
        <div
          className={`absolute inset-0 code-bg-pattern ${
            darkMode ? "dark" : "light"
          }`}
        ></div>
      ...
      {/* Main content container - all content is relative to the background */}
